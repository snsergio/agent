...
echo "##### Initiating Eyeflow EDGE #####" | sudo tee -a /opt/eyeflow/install/edge-install.log
date | sudo tee -a /opt/eyeflow/install/edge-install.log
if [ "$EUID" -ne 0 ]; then
    echo "Please run as root" | sudo tee -a /opt/eyeflow/install/edge-install.log
    exit
fi
...
lspci | grep -i nvidia | sudo tee -a /opt/eyeflow/install/edge-install.log
if [ ! $(lsb_release -sr) == "22.04" ]; then
    echo "OS is not Version 22.04" | sudo tee -a /opt/eyeflow/install/edge-install.log
    exit
fi
lsb_release -si | sudo tee -a /opt/eyeflow/install/edge-install.log
lsb_release -sr | sudo tee -a /opt/eyeflow/install/edge-install.log
...
if [ -f /opt/eyeflow/install/edge-option-1 ]; then
    echo "##### running script for Edge Python on Ubuntu Station" | sudo tee -a /opt/eyeflow/install/edge-install.log
    if [ ! -f /opt/eyeflow/install/resume-status ]; then
        ...
        echo "##### Rebooting..." | sudo tee -a /opt/eyeflow/install/edge-install.log
        script="sudo bash /opt/eyeflow/install/install-edge.sh"
        touch /home/eyeflow/.bash_login
        echo 'echo "###########################################################################"' > /home/eyeflow/.bash_login
        echo 'echo "#    Resuming EDGE Python on Ubuntu installation - Enter SUDO password    #"' >> /home/eyeflow/.bash_login
        echo 'echo "###########################################################################"' >> /home/eyeflow/.bash_login
        ...
        echo "#################################################################################"
        echo "##### Rebooting at: #####" | sudo tee -a /opt/eyeflow/install/edge-install.log
        date | sudo tee -a /opt/eyeflow/install/edge-install.log
        reboot
    else
        echo "##### return from boot - resuming Edge Python on Ubuntu Installarion" | sudo tee -a /opt/eyeflow/install/edge-install.log
        date | sudo tee -a /opt/eyeflow/install/edge-install.log
        ...
        echo "##### Remove temporary files" | sudo tee -a /opt/eyeflow/install/edge-install.log
    ...
    echo "##### running script for Edge Python on Docker" | sudo tee -a /opt/eyeflow/install/edge-install.log
    if [ ! -f /opt/eyeflow/install/resume-status ]; then
        echo "##### running script for the first time.." | sudo tee -a /opt/eyeflow/install/edge-install.log
        apt update | sudo tee -a /opt/eyeflow/install/edge-install.log
        apt -y upgrade | sudo tee -a /opt/eyeflow/install/edge-install.log
        ...
        echo "##### return from boot - resuming Edge Python on Docker Installarion" | sudo tee -a /opt/eyeflow/install/edge-install.log
        date | sudo tee -a /opt/eyeflow/install/edge-install.log
        echo "##### nvidia-smi output:" | sudo tee -a /opt/eyeflow/install/edge-install.log
        nvidia-smi | sudo tee -a /opt/eyeflow/install/edge-install.log
        ...
        echo "##### Docker access to NVIDIA GPU - NVIDIA-SMI from Container" | sudo tee -a /opt/eyeflow/install/edge-install.log
        ...
        touch docker_edge_interactive.sh
    ...
    echo "C++ on Docker"
    echo "##### running script for Edge C++ on Docker" | sudo tee -a /opt/eyeflow/install/edge-install.log
