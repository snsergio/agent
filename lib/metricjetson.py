...
# -*- coding: utf-8 -*-
#######################################################################################################################
versao = "metricjetson-v5.00-beta-test"
#######################################################################################################################
import logging
import time
...
class jetson_exec:
    def collect_jetson(getJetson):
        ...
        if jetsonout != 0: jetsonMetrics = jetson_exec.jetson_metrics(jetsonout, c.logFirstRun)
    ...
    def collect_jtop(resposta):
        ...
        return resposta
        #----------------------------------------------------------------------------------------------------------------------
    def jetson_metrics(jetsonData, logFirstRun):
        resposta = {
            "card": "",
            "driver": "",
            "cuda": "",
