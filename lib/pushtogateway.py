...
class push_data:
    ...
    def __init__(self, configDict, metricDict):
        ...
        self.collectorVersion = Info("agent_version", "Collector Agent Version", ["job", "customer", "station", "host"], registry=self.registry)
    ...
    def set_data(self):
        ...
        self.collectorVersion.labels(job="sergioteste", customer=self.configDict["customerName"], station=self.configDict["stationName"], host=self.configDict["hostName"]).info({"agent_version": versao})
